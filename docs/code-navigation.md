...
| Native handoffs, subagent provenance and result collection | `native_agents.py` |
| Packaged host roles and entry skill | `resources/product/`; generated by `scripts/sync_native_assets.py` |
