# Vendored verbatim from https://github.com/databricks/officeqa (reward.py),
# Apache-2.0, (c) Databricks. Do not hand-edit; pin upstream instead.
# Retrieved 2026-09-04 @ main.
